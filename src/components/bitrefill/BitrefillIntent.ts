...
const DESTINATION_MAP: Record<string, string> = {
  ...
  "oman": "OM", muscat: "OM",
  bahrain: "BH",
  israel: "IL", telaviv: "IL", "tel aviv": "IL",
...
const COUNTRY_PRODUCTS: Record<string, string[]> = {
  ...
  KH: ["google-play", "netflix"],
  MM: ["google-play", "netflix"],
  TR: ["google-play", "netflix", "uber", "spotify"],
  IL: ["google-play", "netflix", "spotify"],
  NL: ["amazon", "netflix", "spotify", "google-play"],
  CH: ["amazon", "netflix", "spotify", "google-play"],
  SE: ["google-play", "netflix", "spotify"],
  NO: ["google-play", "netflix", "spotify"],
  DK: ["google-play", "netflix", "spotify"],
  FI: ["google-play", "netflix", "spotify"],
  PT: ["google-play", "netflix", "spotify"],
  GR: ["google-play", "netflix", "uber"],
  PL: ["google-play", "netflix", "uber"],
  CZ: ["google-play", "netflix", "uber"],
  AT: ["amazon", "netflix", "spotify", "google-play"],
  IE: ["amazon", "netflix", "spotify", "google-play"],
  AR: ["google-play", "netflix", "uber", "spotify"],
  CL: ["google-play", "netflix", "uber"],
  CO: ["google-play", "netflix", "uber"],
  PE: ["google-play", "netflix", "uber"],
  KE: ["google-play", "netflix"],
  NG: ["google-play", "netflix"],
  MA: ["google-play", "netflix"],
  NZ: ["amazon", "netflix", "spotify", "google-play"],  DEFAULT: ["amazon", "netflix", "uber", "google-play", "spotify"],
};
